...
var remainingSpace = { top: 1, left: 1, right: 1, bottom: 1 };
  ...
  _createClass(SwipeCards, [{
    ...
    value: function removeCard(side, cardId) {
      ...
      setTimeout(function () {
        ...
        return _this2.setState((_this2$setState = {}, _defineProperty(_this2$setState, 'alert' + side, false), _defineProperty(_this2$setState, 'remainingSpace', remainingSpace), _this2$setState));
      }, 300);
    ...
    value: function render() {
      ...
      var _cards = children.reduce(function (memo, c, i) {
        ...
        var props = _extends({
          ...
          onPan: function onPan(remainingSpace) {
            return _this3.setState({ remainingSpace: remainingSpace });
          }
      ...
      return _react2.default.createElement(
        ...
        _utils.DIRECTIONS.map(function (d) {
          var alertRender = _this3.props['alert' + d];
          if (typeof alertRender === 'function') return alertRender(_extends({}, _this3.state.remainingSpace, { key: d }));
